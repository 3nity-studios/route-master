...
TEST_CASE("Leave passengers", "[leave_passengers]") {
    ...
    BusStop bus_stop(2, "Terminal", 5, 4, 3, 2, 1, 50, 50);
...
TEST_CASE("Adding bus stop to city", "[add_bus_stop]") {
    City city;
    BusStop bus_stop(1, "Stop1", 5.0, 5.0, 3.0, 3.0, 2.0, 50, 50);
...
TEST_CASE("Adding street to city", "[add_street]") {
    City city;
    BusStop stop1(1, "Stop1", 5.0, 5.0, 3.0, 3.0, 2.0, 50, 50);
    BusStop stop2(2, "Stop2", 5.0, 5.0, 3.0, 3.0, 2.0, 50, 50);
...
TEST_CASE("Run simulation", "[run_simulation]") {
    ...
    BusStop stop1(1, "Stop1", 5.0, 5.0, 3.0, 3.0, 2.0, 50, 50);
    BusStop stop2(2, "Stop2", 10.0, 10.0, 3.0, 3.0, 2.0, 50, 50);
    BusStop stop3(3, "Stop3", 15.0, 15.0, 3.0, 3.0, 2.0, 50, 50);
